...
final class PresentationRequestViewModel<Router: RouterHost>: BaseRequestViewModel<Router> {
  ...
  override func onShare() {
    ...
    override func getSuccessRoute() -> AppRoute? {
        if interactor.presentationCoordinator.needsPinCheck() {
            return AppRoute.biometry(
            ...
            return AppRoute.presentationLoader(getRelyingParty(), presentationCoordinator: interactor.presentationCoordinator)
        }
    }
