...
final class ProximityRequestViewModel<Router: RouterHost>: BaseRequestViewModel<Router> {
  ...
  override func getSuccessRoute() -> AppRoute? {
      if interactor.presentationSessionCoordinator.needsPinCheck() {
          ...
          return AppRoute.proximityLoader(getRelyingParty(), presentationCoordinator: interactor.presentationSessionCoordinator)
      }
  }
