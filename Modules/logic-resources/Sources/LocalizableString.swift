...
public final class LocalizableString: LocalizableStringType {
    ...
    public func get(with key: Key) -> String {
        ...
        case .welcome:
            bundle.localizedString(forKey: "welcome")
        case .welcomeBack:
        ...
        case .quickPinSetTitleTwo:
            bundle.localizedString(forKey: "quick_pin_set_title_step2")
        ...
        case .identify:
            bundle.localizedString(forKey: "identify")
        ...
        case .presentationDataCaption:
            bundle.localizedString(forKey: "presentation_data_caption")
        case .presentationDataCaptionSubline:
            bundle.localizedString(forKey: "presentation_data_caption_subline")
        case .empty:
            bundle.localizedString(forKey: "")
        case .doneExclamationmark:
            bundle.localizedString(forKey: "done_exclamationmark")
        case .closeButton:
            bundle.localizedString(forKey: "close_btn")
        case .proxyDetailTitle:
            bundle.localizedString(forKey: "proxy_detail_title")
        case .proxyDetailCapition:
            bundle.localizedString(forKey: "proxy_detail_caption")
        case .proxyDetailSubtitle:
            bundle.localizedString(forKey: "proxy_detail_subtitle")
        case .proxyDetailInfoOne:
            bundle.localizedString(forKey: "proxy_detail_info_one")
        case .proxyDetailInfoTwo:
            bundle.localizedString(forKey: "proxy_detail_info_two")
        case .onboardingInfoOne:
            bundle.localizedString(forKey: "onboarding_info_one")
        case .onboardingInfoTwo:
            bundle.localizedString(forKey: "onboarding_info_two")
        case .onboardingtitleOne:
            bundle.localizedString(forKey: "onboarding_title_one")
