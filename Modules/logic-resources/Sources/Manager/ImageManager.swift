...
final class ImageManager: ImageManagerProtocol {
    ...
    enum ImageEnum: String {
        ...
        case ident = "ic-small-ident"
        case browserIcon = "safari"
    ...
    var checkmarkCircleFill: Image {
        Image(ImageEnum.checkmarkCircleFill.rawValue, bundle: bundle)
    }
    ...
    var ident: Image {
        Image(ImageEnum.ident.rawValue, bundle: bundle)
    }
    var browserIcon: Image {
        Image(systemName: ImageEnum.browserIcon.rawValue)
    }
    var confirmId: Image {
        Image(ImageEnum.confirmId.rawValue, bundle: bundle)
    }
    var identID: Image {
        Image(ImageEnum.identID.rawValue, bundle: bundle)
    }
    var lock: Image {
